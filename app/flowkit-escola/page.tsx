...
export const metadata: Metadata = {
  title: "FlowKit Escola — Agente de Matrículas com IA | JS Soluções",
  description:
    "Como o personagem 'Alex' automatizou 100% do funil de vendas de uma escola de idiomas — do lead ao contrato — via WhatsApp, n8n e Groq Llama 4 Scout, respondendo em menos de 2 segundos.",
};
...
// Real stack from arquitetura.md
const STACK = [
...
// Real workflow steps from arquitetura.md + fluxos/visao-geral.md
const FLOW_STEPS = [
  {
    wf: "WF1",
    title: "Orquestrador",
  ...
  {
    wf: "WF7",
    title: "Processamento de Matrícula",
...
// Real problems from arquitetura.md context
const PROBLEMS = [
  "Leads que mandavam mensagem às 22h não tinham resposta até o dia seguinte — e já haviam escolhido outra escola",
...
// ─── Page ─────────────────────────────────────────────────────────────────────
export default function FlowKitEscola() {
  return (
    <div className="bg-navy min-h-screen text-white font-sans">
      ...
      <main className="pt-16">
        ...
        <section className="relative py-24 overflow-hidden">
          ...
          <div className="relative max-w-5xl mx-auto px-6">
            ...
            <p className="text-lg text-stone-400 max-w-2xl mb-12 leading-relaxed">
              ...
              — Sondagem → Pitch → Negociação → Matrícula — 24h por dia, respondendo em menos de 2 segundos,
        ...
        <section className="py-20">
          <div className="max-w-5xl mx-auto px-6">
            ...
            <h2 className="text-3xl font-bold mb-4">Conheça Alex — seu vendedor 24h no WhatsApp.</h2>
            <p className="text-stone-400 mb-10 max-w-2xl leading-relaxed">
        ...
        <section className="py-20 bg-navy-light/50">
          <div className="max-w-5xl mx-auto px-6">
            ...
            <p className="text-stone-400 mb-12 max-w-2xl leading-relaxed">
              ...
              para qualquer escola. O classificador de intenção garante que o lead sempre vá para o agente
              ...
              {FLOW_STEPS.map((step, i) => (
                <div key={step.wf} className="flex gap-5 bg-navy border border-white/5 rounded-2xl p-5 hover:border-white/10 transition-colors">
                  <div className="shrink-0 flex flex-col items-center gap-1">
                    <div
                      className="w-12 h-12 rounded-xl gradient-teal flex flex-col items-center justify-center"
                    >
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {step.tags.map((tag) => (
                        <span
                          key={tag}
                          className="text-xs px-2.5 py-1 rounded-lg border border-white/8 text-stone-500"
                        >
                          {tag}
                        </span>
                      ))}
        ...
        <section className="py-20 bg-navy-light/50">
          <div className="max-w-5xl mx-auto px-6">
            ...
            <div className="grid sm:grid-cols-2 gap-6">
              {[
                { title: "Resposta em < 2 segundos, 24h",   desc: "Leads às 22h recebem resposta antes de pensar em ir para outra escola. Buffer de 15s agrupa mensagens antes de processar." },
        ...
        <section className="py-20">
          <div className="max-w-2xl mx-auto px-6 text-center">
            <h2 className="text-3xl font-bold mb-4">Quer esse sistema na sua escola?</h2>
            <p className="text-stone-400 mb-8 leading-relaxed">
              O FlowKit Escola é customizado para a realidade de cada escola.
            ...
            <p className="mt-4 text-sm text-stone-500">Gratuito. Sem compromisso. Respondemos em até 24h.</p>
          </div>
        </section>
      ...
      <footer className="border-t border-white/5 py-8">
        <div className="max-w-5xl mx-auto px-6 flex flex-col sm:flex-row justify-between items-center gap-4">
          <Link href="/" className="flex items-center gap-3 hover:opacity-80 transition-opacity">
            <LogoMark size={24} />
            <span className="text-sm text-stone-400">© {new Date().getFullYear()} JS Soluções</span>
          </Link>
          <a
            href="https://github.com/JuliaSTDev/n8n-matricula-whatsapp"
            target="_blank"
